...
train_dataset = train_dataset.remove_columns(['airline_sentiment', 'tweet_id', 'tweet_created\t', 'name', 'text', 'label'])
val_dataset = val_dataset.remove_columns(['airline_sentiment', 'tweet_id', 'tweet_created\t', 'name', 'text', 'label'])
